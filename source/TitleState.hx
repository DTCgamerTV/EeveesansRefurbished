...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var bg:FlxSprite = new FlxSprite(-156.4, -70.4).loadGraphic(Paths.image('TitleBG'));
		...
		var path = "mods/" + Paths.currentModDirectory + "/images/titleEnter2.png";
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
			path = "mods/images/titleEnter2.png";
		}
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
			path = "assets/images/titleEnter2.png";
		}
		//trace(path, FileSystem.exists(path));
